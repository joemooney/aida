...
- docs(plans): record EPIC-33 invariant-1 execution log (TASK-133, BUG-431 #1/#3, BUG-250)
- docs(plans): record the 168-spec backlog disposition sweep (2026-06-06) (#557)
- docs: record Session 61 — autonomous /loop night (ADR-2/ADR-3, GitLab hint layer, slice-1b correction) (#512)
