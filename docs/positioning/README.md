...
| [vs-ultraplan.md](vs-ultraplan.md) | Historical note on the removed Ultraplan preview and the still-current pattern: import any external planner's saved brief into AIDA's persistent, graph-integrated plan files. |
