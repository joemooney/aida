...
### 12. Tests landing alongside their modules; integration tests in
...
### 13. Shell-wrapper test in `aida-cli/tests/shell_wrapper.rs` (or wherever
       `shell-init` is exercised today)
