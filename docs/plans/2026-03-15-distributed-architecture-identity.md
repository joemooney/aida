...
```toml
# .aida-workspace
workspace  = "a corporate-disruptive"
aida_path  = "./aida"
...
```bash
mkdir a corporate-workspace && cd a corporate-workspace
git clone git@a corporate:pacgate.git
git clone git@a corporate:pacinet.git
git clone git@a corporate:pacmate.git
git clone git@a corporate:aida.git
...
```
GET /aida/stream?workspace=a corporate-disruptive
