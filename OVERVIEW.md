...
> Stated in the probe's voice: this is the niche the *evidence* points to, not a sales claim. Backing: the theory paper [§7 (the apex claim) + §15](docs/research/2026-07-08-coordinating-multi-vendor-agent-fleets.md) and the two ablations cited below.
