...
skill itself — the skill (`.claude/skills/aida-intent/SKILL.md`) is the comprehension
task the spawned agent follows.

## Instructions (for the spawned agent)

Follow the workflow in `.claude/skills/aida-intent/SKILL.md`:
