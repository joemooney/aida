---
name: Dialog role routes work to implementer
description: When user is in role:dialog, queue implementation work for role:implementer via `aida queue add --for implementer` instead of implementing directly
type: feedback
