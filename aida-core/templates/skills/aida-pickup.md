---
name: aida-pickup
description: Producer/consumer queue loop — peek at the next item routed to your active role, work it, mark it done, repeat.
...
`.aida/discipline/session-discipline.md` § *Finish-state
...
last action. Full protocol: `.aida/discipline/skill-prompt-kinds.md`.
trace:TASK-329
