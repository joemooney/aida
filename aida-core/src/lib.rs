...
// Migration of pre-pool sibling worktrees into the registry (TASK-1009).
pub mod worktree_pool_adopt;
...
pub use meta::{
    get_lane_protocol, get_prompt_template, get_type_protocol, needs_meta_seeding,
    resolve_protocol, seed_meta_requirements, seed_missing_type_protocols, ResolvedProtocol,
...
#[cfg(feature = "native")]
pub use scaffolding::{
    aida_managed_diff_slice, merge_agents_md_aida_block, slot_merge, slots_for_file,
    wrap_with_aida_header, AgentsMdBlockMerge, DiffSlice, FileCategory, ProjectType,
